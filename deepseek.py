...
def initialize_session_state():
    ...
    default_state = {
        'text_history': [],
        'generating': False,
        'background_theme': 'golden_elegance',
        'text_color': '#FFD700',
        'shadow_color': '#8B4513',
            ...
            with st.spinner("Generating preview..."):
                try:
                    ...
                    preview_config = {
                        ...
                        'shadow_color': st.session_state.shadow_color,
...
def main():
    ...
    if GROQ_API_KEY:
        ...
        with col1:
            ...
            if st.button("🛠️ Generate Content", disabled=st.session_state.generating):
                if topic:
    ...
    with st.expander("🎨 Animation Settings", expanded=True):
        ...
        with col2:
            text_color = st.color_picker("Text Color", st.session_state.text_color, key="text_color_picker")
            shadow_color = st.color_picker("Shadow Color", st.session_state.shadow_color, key="shadow_color_picker")
            # Update session state safely
